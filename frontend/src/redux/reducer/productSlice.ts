...
const initialState: ProductState = localStorageData
  ? localStorageData.product
  : {
      products: [],
      loading: false,
      error: null
  ...
  createAxiosInstance(navigate)
    ...
    .catch((error: AxiosError) => {
      if (error.response && error.response.data) {
        ...
        dispatch(fetchProductsFailure(errorData));
      } else {
...
export const putProduct =
  (navigate: any, updateProduct: FormData, id: string) =>
...
export const deleteProduct =
  (navigate: any, deleteProductId: string) => async (dispatch: AppDispatch) => {
    dispatch(fetchProductsStart());
