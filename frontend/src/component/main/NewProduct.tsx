...
export const NewProduct: React.FC = () => {
  ...
  return (
    <>
      <section
        id="newProduct"
        className="relative flex w-full items-center justify-center bg-fcolor top-16 mb-10 pb-10"
      >
        <div className="flex md:flex-row flex-col gap-x-20 justify-center overflow-hidden max-w-screen-xl mt-[20px]">
          ...
          <div className="font-archivo-black gap-y-20 md:text-left text-center h-full">
            ...
            <h4 className="text-[25px] text-orange-500 mt-5">
              {NEW_PRODUCT.price}
            </h4>
            <button
              className="border border-4 border-double hover:border-solid border-orange-500 text-orange-500 text-[20px] p-4 rounded-full mt-5"
              onClick={addToCart}
            >
              Add to Cart
            </button>
