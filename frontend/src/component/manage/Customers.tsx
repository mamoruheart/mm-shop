...
import { faCirclePlus, faCloudUpload, faEdit, faSearch, faTrash } from '@fortawesome/free-solid-svg-icons';
import { useDispatch, useSelector } from 'react-redux';
import { RootState } from '../../redux/store';
import { useEffect, useRef, useState } from 'react';
import { getCategorys } from '../../redux/reducer/categorySlice';
import { actionType, customerState } from '../../constant';
import { useSnackbar } from '../utils/SnackbarProvider';
import { Data } from '../types';
import DeleteIcon from '@mui/icons-material/Delete'
import EditIcon from '@mui/icons-material/Edit'
import { deleteCustomer, postCustomer, putCustomer } from '../../redux/reducer/customerSlice';
...
export default function Customers( props: any ) {
  ...
  const filterOrders = (e: any) => {
    setRows(props.rows.filter((row:any) => row.product.toLowerCase().indexOf(e.target.value.toLowerCase()) != -1))
  }
                      ...
                      <DialogContent>
                        ...
                        <Grid container spacing={0} className='gap-x-10'>
                          ...
                          <FormControl variant="standard" sx={{ m: 1, minWidth: 220 }}>
                            <InputLabel id="demo-simple-select-standard-label">Account State *</InputLabel>
                            <Select
                              required
