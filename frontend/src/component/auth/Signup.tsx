...
import { login, signup } from "../../redux/reducer/authSlice";
...
export const Signup : React.FC = () => {
    ...
    return (
      <ThemeProvider theme={defaultTheme}>
        <Container component="main" maxWidth="xs" className="bg-white p-2 m-16 rounded-xl">
          <Box
            className="bg-white flex items-center flex-col mt-10"
          >
            ...
            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
              ...
              <Grid container justifyContent="flex-end">
                <Grid item>
                  <Link onClick={()=>{navigate('/login')}} variant="body2" className="cursor-pointer">
