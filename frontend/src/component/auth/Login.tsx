...
import { APPLE_CLIENT_ID, APPLE_REDIRECT_URL, APPLE_SCOPE } from "../../constant";
      ...
      <ThemeProvider theme={defaultTheme} >
        ...
        <div className="flex flex-col md:w-[50%] w-screen">
          ...
          <div className="flex flex-col justify-center h-full">
            <Container component="main" maxWidth="xs" className="bg-white p-2 pb-5 rounded-xl">
              <Box
                className="bg-white flex items-left flex-col mt-10"
              >
                <Typography component="h1" variant="h5" className="text-left">
                  Sign In
                </Typography>
                <div>New to Here? <a className="text-[#1e77cf] cursor-pointer" onClick={()=>{navigate('/register')}} >Sign Up</a></div>
                <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
                  <Grid container spacing={2}>
                    <Grid item md={6} xs={12} className="flex flex-row justify-center">
                      <GoogleLogin
                  ...
                  <Grid container className='flex flex-row justify-between'>
                    <Grid item className=' pt-2'>
                        <a className="underline underline-offset-auto cursor-pointer text-[#0000aa]">Forgot Password?</a>
                    </Grid>
        ...
        <div className="flex flex-col md:w-[50%] bg-[url('/images/Map.PNG')] bg-cover">
        </div>
      </ThemeProvider>
      </div>
    );
