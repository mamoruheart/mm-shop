...
import { createOrder, getOrders, postOrder } from "../../redux/reducer/orderSlice";
          ...
          <div className="mt-1 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-6">
              <label htmlFor="username" className="block text-md font-medium leading-6 text-gray-900">
                FFL Copy *
                <br></br>
                <span className="text-sm font-light text-gray-400">DO NOT transform or edit photo. Delivery will be perform to your FFL address</span>
              </label>
              <div className="mt-2">
                ...
                >
                  Upload FFL
                  <input hidden type="file" name='file' onChange={(e)=>{
                    if (e.target.files) {
            ...
            <div className="sm:col-span-6">
              ...
              <div className="mt-2">
                <div className="flex md:flex-row flex-col rounded-md shadow-sm ring-gray-300 gap-x-5">
                  <TextField name="bill_city" label="City" variant="standard" size="small" className="w-full" required/>
                  <TextField name="bill_state" label="State" variant="standard" size="small" className="w-full" required/>
                  <TextField name="bill_zip" label="Zip Code" variant="standard" size="small"  className="w-full" required/>
                </div>
              </div>
            </div>
            <div className="sm:col-span-6">
              ...
              <div className="mt-2">
                <div className="flex md:flex-row flex-col rounded-md shadow-sm ring-gray-300 gap-x-5">
                  ...
                  <TextField name="deli_city" label="City" variant="standard" size="small" className="w-full" required/>
                  <TextField name="deli_state" label="State" variant="standard" size="small" className="w-full" required/>
                  <TextField name="deli_zip" label="Zip Code" variant="standard" size="small"  className="w-full" required/>
                </div>
              </div>
            </div>
            <div className="sm:col-span-6">
            ...
            <div className="sm:col-span-6">
              <label htmlFor="username" className="block text-md font-medium leading-6 text-gray-900">
                Products
                <span className="ml-2 text-sm font-light text-gray-400">Total ${totalPrice} (exclude Delivery Fee)</span>
              </label>
              {
                cartItems.items.map((item, index) => (
                  ...
                  <ul className="sm:px-10 flex flex-row sm:w-full justify-between">
                    <div className="flex flex-col items-start justify-between">
                      <h2 className="text-dm text-gray-900">{item.title} {item.caliber !== 0 ? item.caliber + 'mm' : ''} </h2>
                    </div>
                    <div className="flex flex-col items-start justify-between">
                      <h2 className="text-md text-gray-900"> {item.quantity} Pieces</h2>
                    </div>
